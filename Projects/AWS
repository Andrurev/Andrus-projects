Create an AWS account and set up a Virtual Private Cloud (VPC) with a public and private subnet, as well as a NAT gateway for outbound internet access from the private subnet
